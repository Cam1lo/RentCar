...
public class Cars {
    ...
    public void onInit(ArrayList<CarDto> items, AnchorPane parentApContent) {
        ...
        modelColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getModel().getModel()));
        statusColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getStatus().getStatus()));
        mileageColumn.setCellValueFactory(new PropertyValueFactory<>("km_driver"));
